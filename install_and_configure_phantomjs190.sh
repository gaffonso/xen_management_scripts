...
wget https://phantomjs.googlecode.com/files/phantomjs-1.9.0-linux-x86_64.tar.bz2 -P /stor/downloads/
tar xpvf /stor/downloads/phantomjs-1.9.0-linux-x86_64.tar.bz2
